...
### Changed
- Expanded dependency constraints to support `pointycastle: '>=3.7.3 <5.0.0'` and `xml: '>=6.3.0 <8.0.0'`.
- Enhanced end-to-end test suite to verify decompressed OOXML ZIP structure and XML workbook validation.
